...
<form id="contact-form" method="post" action="postback">
    <div class="form-item">
        ...
        <input class="title" type="text" name="name" id="name" />
    </div>

    <div class="form-item">
        <label for="email">{_ E-mail _}</label>
        <input class="title" type="text" name="mail" id="mail" />
    ...
    <button type="submit" class="classy" style="float: right;">{_ Send _}</button>
</form>
