...
<div class="span-16" id="signup_area">
	...
	<form id="signup_form" class="setcookie" method="post" action="postback">
		...
		<div id="signup_name_first">
			...
			{% else %}
				<input class="title" id="name_first" name="name_first" type="text" value="{{ name_first|escape }}" />
		...
		<div id="signup_surname_prefix">
			...
			<input  class="title" id="surprefix" name="surprefix" type="text" value="" />
		</div>
		{% endif %}
		...
		<div id="signup_name_surname">
			...
			{% else %}
				<input class="title" id="name_surname" name="name_surname" type="text" value="{{ name_surname|escape }}" />
		...
		<div id="signup_email">
			...
			{% else %}
				<input class="title" id="email" name="email" type="text" value="{{ email|escape }}" />
		...
		{% if not xs_props %}
			...
			<div id="signup_username">
				...
				<input class="title" id="username" name="username" type="text" value="" />
			...
			<div id="signup_password1">
				...
				<input class="title" id="password1" name="password1" type="password" value="" autocomplete="off" />
			...
			<div id="signup_password2">
				...
				<input class="title" id="password2" name="password2" type="password" value="" autocomplete="off" />
		...
		<div id="signup_tos">
			...
			<input class="title" type="checkbox" name="signup_tos_agree" id="signup_tos_agree" value="1" />
			<label for="signup_tos_agree">{_ I agree to the _} <a target="_blank" href="{{ m.rsc.signup_tos.page_url }}">{{ m.rsc.signup_tos.title }}</a>
				{_ and the _} <a target="_blank" href="{{ m.rsc.signup_tos.page_url }}/#privacy">{_ Privacy policies _}</a>.</label>
